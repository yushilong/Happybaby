 ...
 */
class HBIcsLinearLayout extends LinearLayout {
    ...
    public HBIcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(HBIcsLinearLayout.LL_DIVIDER));
